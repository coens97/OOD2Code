...
namespace FlowSystem.Data.Utility
{
    public static class DataTransformation
    {
        ...
        private static IEnumerable<PipeFile> GetPipesFile(this FlowNetworkEntity source, IReadOnlyDictionary<IComponent, int> components)
        {
        ...
        public static FlowFile ToFlowFile(this FlowNetworkEntity source)
        {
            ...
            var components = new Dictionary<IComponent, int>();
