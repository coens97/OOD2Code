...
namespace FlowSystem.Data.Utility
{
    public static class DataTransformation
    {
        ...
        private static IEnumerable<PipeFile> GetPipesFile(this FlowNetworkEntity source, IReadOnlyDictionary<IComponentEntity, int> components)
        {
        ...
        public static FlowFile ToFlowFile(this FlowNetworkEntity source)
        {
            ...
            var components = new Dictionary<IComponentEntity, int>();
        ...
        public static FlowNetworkEntity FromFlowFile(this FlowFile source)
        {
            ...
            var components = new List<IComponentEntity>();
            ...
            var ids = new Dictionary<int, IComponentEntity>();
